...
<body>
	...
	<!--<a href="logout.php" style="float:right;margin-top:0px; padding:3px 12px;">Logout</a>
	 <a href="login.html" style="float:right;margin-top:0px; padding:3px 12px;">Login</a>
	<a href="cart.php" style="float:right;margin-top:0px; padding:3px 12px;" >Cart</a> -->
...
<br/>
<br/>
<form action="home.php" method="get" style="padding:10px; float:right;">
